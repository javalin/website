...
Measuring memory usage of a process is not very straight-forward. There are several metrics - according so some post on [Stackoverflow](https://stackoverflow.com/questions/131303/how-to-measure-actual-memory-usage-of-an-application-or-process) RSS is a good metric: So let’s use check this out:
