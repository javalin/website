...
summary: Create a basic Javalin application with filters, controllers, authentication, localization, etc.
---

## What You Will Learn

You will learn how to create a basic Javalin application with filters, controllers, views, authentication, localization, error handling, and more, but this is not really a full blown tutorial, it's more a description of a basic structure, with certain points of the code highlighted. To get the full benefit of this tutorial, please clone the example on <a href="https://github.com/tipsy/javalin-structure-example" target="_blank">GitHub</a>, run it, and play around.

### Screenshot
<img src="/img/posts/javalinBasicStructure/screenshot.png" alt="Application Screenshot">
...
## Package structure
<img src="/img/posts/javalinBasicStructure/packageOverview.png" alt="Package Structure">
...
## Conlusion
Hopefully you've learned a bit about Javalin, and also Java and webapps in general. If you disagree with any choices made in the example-app, please create an issue on <a href="https://github.com/tipsy/javalin-structure-example" target="_blank">GitHub</a>. This example will hopefully continue to evolve based on feedback and new Javalin features.
