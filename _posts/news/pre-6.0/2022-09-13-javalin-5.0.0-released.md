...
The codebase is about *7000 lines of Java/Kotlin code*, and about *10 000 lines of test* (629 tests).\\
The project would not have been possible without JVM open-source community,
which is one of the things that make the JVM ecosystem the best in the world.
Javalin has been around for five years now, and at the time of writing has *161* contributors,
*497 forks*, and about *250 000 monthly downloads*.
*552 pull requests* have been merged and *990 issues* have been closed since 2017.
